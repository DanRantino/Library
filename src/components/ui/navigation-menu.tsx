...
function NavigationMenu({
                          ...
                          children,
                          viewport = true,
                          side = 'right', // valor padrão: abre à direita
                          ...props
                        }: NavigationMenuProps) {
  return (
    <NavigationMenuPrimitive.Root
      ...
      data-side={side} // prop opcional para controle global
      className={cn(
    ...
    >
      {children}
      {viewport && <NavigationMenuViewport side={side} />}
    </NavigationMenuPrimitive.Root>
  );
}
...
interface NavigationMenuPrimitive extends React.ComponentProps<typeof NavigationMenuPrimitive.Viewport> {
  side: string;
}
  ...
  return (
    <div
      className={cn(
        ...
        side === 'left' ? 'left-auto right-0' : 'left-0 right-auto',
      )}
    >
